...
class HomebaseController extends AppframeController {
	...
	protected function  check_user(){
		$user_status=M('User')->where(array("id"=>sp_get_current_userid()))->getField("user_status");
//		if($user_status==2){
...
//		}
	...
	public function display($templateFile = '', $charset = '', $contentType = '', $content = '', $prefix = '') {
		trace('display page '.$this->parseTemplate($templateFile).', templateFile:'.$templateFile);
